...
export const controlEventListenerWID = (
  ...
  canvas.addEventListener(
    ...
    (event) => {
      ...
      window.shareApp.controlWID(windowId, button);
  ...
  canvas.addEventListener(
    ...
    (event) => {
      ...
      window.shareApp.controlWID(windowId, motion);
  ...
  canvas.addEventListener(
    ...
    (event) => {
      ...
      window.shareApp.controlWID(windowId, buttonDown);
      window.shareApp.controlWID(windowId, buttonUp);
  ...
  canvas.addEventListener(
    ...
    (event) => {
      ...
      if (keyJson) {
        window.shareApp.controlWID(windowId, keyJson);
        if (event.key === "Hankaku" || event.key === "Zenkaku") {
          keyJson.key.down = true;
          window.shareApp.controlWID(windowId, keyJson);
        }
      }
